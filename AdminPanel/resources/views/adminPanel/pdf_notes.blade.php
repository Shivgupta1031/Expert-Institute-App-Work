            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">PDF Notes</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">PDF Notes</h3>
                            </div>
                            <div class="col-lg-6 col-5 text-right">
                                <a class="btn btn-sm btn-primary" href="#" role="button" data-toggle="modal"
                                    data-target="#addPdfNotesItem" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-plus"></i>
                                </a>
                                <div class="modal text-left" id="addPdfNotesItem">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content justify-content-center">
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h2 class="modal-title">Add PDF Notes</h2>
                                            ...
                                            <div class="modal-body model">
                                                <form method="post" action="{{ route('addPdfNotesItem') }}"
                                                    ...
                                                    <br>
                                                    <div class="form-group">
                                                        <label class="h4" for="course_id">Select Course</label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" href="#" role="button"
                                                data-toggle="modal" data-target="#editPdfNotesItem{{ $item['id'] }}"
                                                aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a class="btn btn-sm btn-primary text-white"
                                                href="{{ route('deletePdfNotesItem') }}?id={{ $item['id'] }}"
                                        ...
                                        <div class="modal text-left" id="editPdfNotesItem{{ $item['id'] }}">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content justify-content-center">
                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                    ...
                                                    <!-- Modal body -->
                                                    <div class="modal-body model">
                                                        <form method="post" action="{{ route('editPdfNotesItem') }}">
                                                            @csrf
                                                            <input hidden type="text" class="form-control"
                                                                id="id" name="id"
                                                                value="{{ $item['id'] }}" />
                                                            <div class="form-group">
                                                                <label for="id{{ $item['id'] }}">PDF Notes ID</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="course_id{{ $item['id'] }}"><span
                                                                        class="h4">Paid Course</span></label>
