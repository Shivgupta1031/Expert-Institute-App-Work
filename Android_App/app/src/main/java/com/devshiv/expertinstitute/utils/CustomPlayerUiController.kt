...
class CustomPlayerUiController(
    ...
    val rootView: View = View.inflate(youTubePlayerView.context, R.layout.custom_player_ui, null)
    ...
    private fun updatePlayPauseButtonIcon(playing: Boolean) {
        val drawable =
            if (playing) com.pierfrancescosoffritti.androidyoutubeplayer.core.customui.R.drawable.ayp_ic_pause_36dp else com.pierfrancescosoffritti.androidyoutubeplayer.core.customui.R.drawable.ayp_ic_play_36dp
